    ...
    <Card>
      <CardHeader className="flex flex-row items-center justify-between gap-3">
        <button
          ...
          aria-label={
            collapsed ? "Expandir entrenadores del club" : "Contraer entrenadores del club"
          }
        >
          <ChevronDown
            className={cn(
            ...
            >
              <div className="grid gap-3 sm:grid-cols-[1fr_1fr_auto] sm:items-end">
                <div className="grid gap-1.5">
                  ...
                  <Input id="coachName" name="name" placeholder="Nombre del entrenador" required />
                </div>
                <div className="grid gap-1.5">
                ...
                <SubmitButton>Añadir entrenador</SubmitButton>
              </div>
            </ActionForm>
          )}
          {children}
